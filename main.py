...
if (escolha_usuario == 2)
    ...
    if (escolha1_ave == 1):
        ...
        print("2 – Corte limpo/desossado")
        print("3 - Gostaria de ver ambas as opções")
        escolha2_carne = int(input("Você prefere ave com qual estilo de corte?"))
        ...
        print("2 - Sem molho")
        print("3 - Ambos")
        escolha2_aves = int(input("Você prefere ave com preparo ao molho ou sem molho?"))
...
# ------------------------------ GRÃOS E MASSAS -----------------------------
        ...
        print("2 - Sofisticado/Formal")
        print("3 - Sem ocasião específica")
        escolha1_grãos_massas = int(input("Qual ocasião do encontro de hoje?"))
    
        if (escolha1_ graos_massas == 1):
            print("1 - Grão")
            print("2 - Massa")
            print("3 - Gostaria de ver as opções gerais")
            escolha2_ graos_massas = int(input("Você prefere qual base principal de preparo?"))
        
            if (escolha2_ graos_massas == 1):
                print("A escolha perfeita pra você hoje é: " + graos_massas [0])
            elif (escolha2_ graos_massas == 2):
                print("A escolha perfeita pra você hoje é: " + graos_massas [1])
            elif (escolha2_ graos_massas == 3):
                print("Temos duas opções que podem atender ao seu paladar: " + graos_massas [0] + " e " + graos_massas [1])
            else: 
                print("ERRO: Selecione uma opção válida!")
        
        elif (escolha1_ graos_massas == 2):
            print("O prato perfeito pra você hoje é: " + graos_massas [2])
            
        elif (escolha1_ graos_massas == 3):
            print("1 – Encorpada")
            print("2 - Cremosa")
            print("3 – Leve")
            print("4 – Gostaria de ver as opções gerais")
            escolha2_ graos_massas = int(input("Você prefere pratos com qual tipo de textura?"))
            ...
            if (escolha2_ graos_massas == 1):
                ...
                print("A escolha perfeita pra você hoje é: " + graos_massas [2])
                 ...
                 print("A escolha perfeita pra você hoje é: " + graos_massas [0])
            elif (escolha2_ graos_massas == 4):
                 print("Temos três opções que podem atender ao seu paladar: " + graos_massas [0] + " , " + graos_massas [1] + “ e “ + graos_massas [2])
            else: 
                print("ERRO: Selecione uma opção válida!")    
...
# ------------------------------ SOBREMESAS -----------------------------
    ...
    if (escolha1_ sobremesas == 1):
        print(“A escolha perfeita para você hoje é: “ + sobremesas [0])
        if (escolha1_ sobremesas == 2):
            print("A escolha perfeita pra você hoje é: " + sobremesas [1])
        if (escolha1_ sobremesas == 3):
            print("A escolha perfeita pra você hoje é: " + sobremesas [2])
        elif (escolha2_ sobremesas == 4):
            print("Temos três opções que podem atender ao seu paladar: " + sobremesas [0] + " , “ + sobremesas[1]” + “ e " + sobremesas [2])
        else: 
            print("ERRO: Selecione uma opção válida!")
...
# ------------------------------ BEBIDAS -----------------------------
    ...
    print("3 - Essencial")
    print(“4 – Gostaria de ver as opções gerais “)
    escolha1_sobremesas = int(input("Qual apelo gastronômico você quer fazer uso para escolher sua bebida hoje?))
    
    if (escolha1_ bebidas == 1):
        print(“A escolha perfeita para você hoje é: “ + bebidas [0])
        if (escolha1_ bebidas == 2):
            print("A escolha perfeita pra você hoje é: " + bebidas [1])
        if (escolha1_ bebidas == 3):
            print("A escolha perfeita pra você hoje é: " + bebidas [2])
        elif (escolha2_ bebidas == 4):
            print("Temos três opções que podem atender ao seu paladar: " + bebidas [0] + " , “ + bebidas[1]” + “ e " + bebidas [2])
        else: 
            print("ERRO: Selecione uma opção válida!")
        else: 
            print("ERRO: Selecione uma opção válida!")    
